...
.btn-success {
  ...
  <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
            ...
            <ul class="list-group">
                <?php foreach ($_SESSION['cart'] as $cart_item): ?>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <img src="data:image/jpeg;base64,<?= $cart_item['image'] ?>" alt="Product Image" style="width: 50px; height: 50px;">
                        <span><?= $cart_item['name'] ?> (x<?= $cart_item['quantity'] ?>)</span>
    ...
    <select name="category" class="filter-categories border-0 mb-0 me-5" onchange="document.getElementById('filter-form').submit();">
        <option value="">Shop by Categories</option>
        <option value="String" <?= (isset($_GET['category']) && $_GET['category'] === 'String') ? 'selected' : '' ?>>String</option>
        <option value="Percussion" <?= (isset($_GET['category']) && $_GET['category'] === 'Percussion') ? 'selected' : '' ?>>Percussion</option>
        <option value="Wind" <?= (isset($_GET['category']) && $_GET['category'] === 'Wind') ? 'selected' : '' ?>>Wind</option>
    </select>
</form>
                  ...
                  <ul class="navbar-nav justify-content-end menu-list list-unstyled d-flex gap-md-3 mb-0">
                    <li class="nav-item active">
                      <a href="#women" class="nav-link">String</a>
                    </li>
                    <li class="nav-item dropdown">
                      <a href="#men" class="nav-link">Percussion</a>
                    </li>
                    <li class="nav-item">
                      <a href="#kids" class="nav-link">Wind</a>
                    </li>
                    <li class="nav-item dropdown">
                ...
                <div class="swiper main-swiper">
                  <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                      <div class="row banner-content p-5">
                        <div class="content-wrapper col-md-7">
                          <div class="categories my-3">100% authentic</div>
                          <h3 class="display-4">Premium Guitar</h3>
                          <p>Strings are guaranteed to be stronger than the connection between you and your favourite person.</p>
                    ...
                    <div class="swiper-slide">
                      <div class="row banner-content p-5">
                        <div class="content-wrapper col-md-7">
                          <div class="categories mb-3 pb-3">100% authentic</div>
                          <h3 class="banner-title">Drum made from leather and metal</h3>
                          <p>Beat it as much as you can, It ain't gonna break.</p>
                    ...
                    <div class="swiper-slide">
                      <div class="row banner-content p-5">
                        <div class="content-wrapper col-md-7">
                          <div class="categories mb-3 pb-3">100% authentic</div>
                          <h3 class="banner-title">Sexy Saxophone</h3>
                          <p>Blow it to become 1000% more attractive.</p>
                          <a href="#" class="btn btn-outline-dark btn-lg text-uppercase fs-6 rounded-1">Shop Collection</a>
                        </div>
                        <div class="img-wrapper col-md-5">
              ...
              <div class="banner-ad bg-success-subtle block-2" style="background:url('images/ad-image-1.png') no-repeat;background-position: right bottom">
                <div class="row banner-content p-5">
                  ...
                  <div class="content-wrapper col-md-7">
                    ...
                    <h3 class="banner-title">Feel the Bass</h3>
              ...
              <div class="banner-ad bg-danger block-3" style="background:url('images/ad-image-2.png') no-repeat;background-position: right bottom">
                <div class="row banner-content p-5">
                  ...
                  <div class="content-wrapper col-md-7">
                    ...
                    <h3 class="item-title">Wind Instruments</h3>
                    <a href="#" class="d-flex align-items-center nav-link">Shop Collection <svg width="24" height="24"><use xlink:href="#arrow-right"></use></svg></a>
                  </div>
        ...
        <div class="bg-warning py-5 rounded-5" style="background-image: url('images/bg-pattern-2.png') no-repeat;">
          <div class="container">
            <div class="row">
              ...
              <div class="col-md-8">
                <h2 class="my-5">Shop faster with our App</h2>
